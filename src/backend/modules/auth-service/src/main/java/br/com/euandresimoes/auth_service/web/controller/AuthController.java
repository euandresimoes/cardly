package br.com.euandresimoes.auth_service.web.controller;
...
public class AuthController {
    ...
    private final UserRegisterImpl registerUseCase;
    private final UserLoginImpl loginUseCase;

    public AuthController(UserRepository userRepo, UserRegisterImpl registerUseCase, UserLoginImpl loginUseCase) {
